 ...
 * PlayerUI frontend design - frontend JS/CSS coding
 * 
...
<head>
    <meta charset="utf-8">
    <title>RaspyFi - Music Player Daemon WebUI</title>
...
<div id="menu-top" class="ui-header ui-bar-f ui-header-fixed slidedown" data-position="fixed" data-role="header" role="banner">
	<div class="dropdown">
		<a class="dropdown-toggle" id="menu-settings" role="button" data-toggle="dropdown" data-target="#" href="<?php echo $sezione ?>.php">SETTINGS <i class="icon-th-list dx"></i></a>
